setwd("/export/home/a-e/cani/eReefs/buoyancy/tran_outputs")
library(dplyr)
library(ggplot2)
#library('ereefs')
library(ncdf4)
...
saveRDS(datapoly_ratio, file = "buoyancy_phyLS_spring.rds")
...
saveRDS(datapolyT, file = "buoyancy_tricho_spring.rds")
...
saveRDS(datapolyDN, file = "buoyancy_din_spring.rds")
...
saveRDS(datapolyDP, file = "buoyancy_dip_spring.rds")
...
saveRDS(datapoly_ratio, file = "buoyancy_phyLS_summer.rds")
...
datapolyT1 <- datapoly_T2$datapoly
datapolyT$value <- (datapolyT$value +datapolyT1$value) / 2
saveRDS(datapolyT, file = "buoyancy_tricho_summer.rds")
...
datapolyDN1 <- datapoly_DN2$datapoly
datapolyDN$value <- (datapolyDN$value +datapolyDN1$value) / 2
saveRDS(datapolyDN, file = "buoyancy_din_summer.rds")
...
datapolyDP1 <- datapoly_DP2$datapoly
datapolyDP$value <- (datapolyDP$value +datapolyDP1$value) / 2
saveRDS(datapolyDP, file = "buoyancy_dip_summer.rds")
