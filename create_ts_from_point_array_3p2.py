...
m_netcdf_main=open('/export/home/a-e/cani/eReefs/buoyancy/gbr4-obs/netcdf_obs_3p2.mnc','r')
...
for j in range((nobs)):  #lopp over sites
    fff=open('/export/home/a-e/cani/eReefs/buoyancy/gbr4-obs/ts_3p2/'+site_name[j]+'.ts','w')
