...
for i=1:length(sites)   
 ...
 %   mod_file3 = strcat('ts_3p2/',sites1{i},'.ts'); %mod3   
   mod_file3 = strcat('ts_buoyancy\',sites1{i},'.ts'); %mod3   
...
%% first plot just a time series of all the member + control :
    ...
    name0 = strcat('png_figures_old_buoyancy_model\',pathn,'\time_series_MMP_',var_names,'_',SITES(i,:),'.png');
    print(name0,'-dpng');
...
s(i,:,2) = [d2DA(2,i),maeDA(2,i),rmsDA(2,i),biasDA(2,i) ];  %control
        ...
        set(gca,'XTickLabelRotation',90)
        name = strcat('png_figures_old_buoyancy_model\',pathn,'\bias_d2_BAR_MMP_',var_names,'.png');
        print('-dpng',name);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%             
 ...
 %       as=nanmean(squeeze(s(:,3,1)))
  %      line9=['3.1: ',sprintf('%.2f',(as))]
        ...
        set(gca,'XTickLabelRotation',90)
        name = strcat('png_figures_old_buoyancy_model\',pathn,'\rms_mae_BAR_MMP_',var_names,'.png');
        print('-dpng',name);
