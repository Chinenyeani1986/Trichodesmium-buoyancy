...
library("patchwork")
library(rgdal)
library("viridis")  # Install

#This script plots spatially-resolved mean Trichodesmium variables

phyls_spring = readRDS("buoyancy_phyLS_spring.rds")
phyls_summer = readRDS("buoyancy_phyLS_summer.rds")
tricho_summer = readRDS("buoyancy_tricho_summer.rds")
tricho_spring = readRDS("buoyancy_tricho_spring.rds")
din_spring = readRDS("buoyancy_din_spring.rds")
din_summer = readRDS("buoyancy_din_summer.rds")
dip_spring = readRDS("buoyancy_dip_spring.rds")
dip_summer = readRDS("buoyancy_dip_summer.rds")
